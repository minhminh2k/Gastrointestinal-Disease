...
from data.kvasir.components.kvasir_transform import Transform_KvasirSEGDataset
...
class KvasirSEGDataModule(LightningDataModule):
    ...
    def setup(self, visualize_dist=False, stage: Optional[str] = None):
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            self.data_train = TransformKvasirSegDataset(self.data_train, self.hparams.transform_train)
            self.data_val = TransformKvasirSegDataset(self.data_val, self.hparams.transform_val)
            self.data_test = TransformKvasirSegDataset(self.data_test, self.hparams.transform_val)
